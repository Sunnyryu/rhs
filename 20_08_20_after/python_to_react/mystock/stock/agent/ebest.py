...
class EBest:
    ...
    def __init__(self, mode=None):
        ...
        :paran mode:str - 모의서버는 DEMO 실서버는 PROD로구분
        """
        ...
        self.passwd_account = config[run_mode]['password_account']
    ...
    def _execute_query(self, res, in_block_name, out_block_name, *out_fields, **set_fields):
        ...
        time.sleep(1)
        print("current querry cnt:", len(self.query_cnt))
    ...
    def get_account_info(self):
        """TR CSPAQ12000 현물계좌 예수금/주문가능금액/총평가
    ...
    def order_stock(self, code, qty, price, bns_type, order_type="00"):
        ...
        """
        in_params = {"AcntNo":self.account, "InptPwd":self.passwd_account, "IsuNo":code, "OrdQty":qty,
