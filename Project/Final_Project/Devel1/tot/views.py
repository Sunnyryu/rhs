...
def graph(request):
    ...
    if a not in words:
        ...
        if len(dict2['top']['value']) > 10:
            ...
            newdict1 = dict2['top']
            newdict1 = newdict1.to_dict()
        context = {'vw1':value_word1, 'word1':word1, 'newdict1': newdict1}
        ...
        context = {'vw1':value_word1, 'vw2':value_word2, 'word1':word1, 'word2':word2, 'newdict2':newdict2, 'newdict1':newdict1}
        return render(request, 'tot/graph.html', context)
