...
var shpPath = {
    ctprvn : {
        source : 'src/CTPRVN_201905/TL_SCCO_CTPRVN.shp',
        convert : 'src/CTPRVN_201905/TL_SCCO_CTPRVN_CONVERT.shp',
        json : 'dist/ctprvn.json'
    },
    sig : {
        source : 'src/SIG_201905/TL_SCCO_SIG.shp',
        convert : 'src/SIG_201905/TL_SCCO_SIG_CONVERT.shp',
        json : 'dist/sig.json'
    },
    emd : {
        source : 'src/EMD_201905/TL_SCCO_EMD.shp',
        convert : 'src/EMD_201905/TL_SCCO_EMD_CONVERT.shp',
        json : 'dist/emd.json'
    }
}
...
function mapshaper(key) {
    var command = 'mapshaper -i '
                + shpPath[key].source
                + ' encoding=euc-kr -simplify weighted 1.0% -o format=shapefile '
                + shpPath[key].convert;
